...
$advance = new Advance();
//if(Input::exists()){
  $advance_id = escape(Input::get('editadvance_id'));
  $advance_payrolltype = escape(Input::get('editadvance_payrolltype'));
  $advance_date = escape(Input::get('editadvance_date'));
  $advance_amount = escape(Input::get('editadvance_amount'));
  $advance_note = escape(Input::get('editadvance_note'));
  ...
  $condition = condition($advance_payrolltypeerror,$advance_dateerror, $advance_amounterror);
    ...
    try{
     $advance = new Advance();
    $advance->updateAdvanceEmployee(array(
