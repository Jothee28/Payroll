...
class User{
	...
	public function searchOnlyUser($id = null){
		if($id){
			$field = (is_numeric($id)) ? 'userID' : 'user';
			$data = $this->_db->get('user', array($field, '=', $id));
			if($data->count()){
				$this->_data = $data->first();
				return $this->_data;
			}else{
	...
	public function searchOnlyUserEmployee($id = null){
		if($id){
			$field = (is_numeric($id)) ? 'userID' : 'employee';
			$data = $this->_db->get('employee', array($field, '=', $id));
			if($data->count()){
				$this->_data = $data->first();
				return $this->_data;
			}else{
	...
	//Function needed for Personal Information section
	public function searchOnlyEmployeePersonalInformation($id = null){
		if($id){
			$field = (is_numeric($id)) ? 'userID' : 'employee';
			$data = $this->_db->get('employee', array($field, '=', $id));
			if($data->count()){
	...
	public function getOnlyEmployeePersonalInformation($id = null){
		if($id){
			$field = (is_numeric($id)) ? 'userID' : 'id';
			$data = $this->_db->get('employee', array($field, '=', $id));
	...
	//Functions needed for Emergency Contact section
	public function searchOnlyEmergencyContact($id = null){
		if($id){
			$field = (is_numeric($id)) ? 'userID' : 'emergency_contact';
			$data = $this->_db->get('emergency_contact', array($field, '=', $id));
			if($data->count()){
				$this->_data = $data->results();
				return $this->_data;
			}else{
	...
	public function getOnlyEmergencyContact($id = null){
		if($id){
			$field = (is_numeric($id)) ? 'userID' : 'id';
			$data = $this->_db->get('emergency_contact', array($field, '=', $id));
	...
	//Functions needed for Payroll Information
	public function searchOnlyPayrollInfo($id = null){
		if($id){
			$field = (is_numeric($id)) ? 'emp_id' : 'payroll_info';
			$data = $this->_db->get('payroll_info', array($field, '=', $id));
			if($data->count()){
				$this->_data = $data->results();
				return $this->_data;
			}else{
	...
	public function getOnlyPayrollInfo($id = null){
			if($id){
				$field = (is_numeric($id)) ? 'userID' : 'id';
				$data = $this->_db->get('payroll_info', array($field, '=', $id));
				if($data->count()){
	...
	//Functions needed for Employment Details section
	public function searchOnlyEmploymentDetails($id = null){
		if($id){
			$field = (is_numeric($id)) ? 'userID' : 'employment_detail';
			$data = $this->_db->get('employment_detail', array($field, '=', $id));
			if($data->count()){
				$this->_data = $data->results();
				return $this->_data;
			}else{
	...
	public function getOnlyEmploymentDetails($id = null){
			if($id){
				$field = (is_numeric($id)) ? 'emp_id' : 'id';
				$data = $this->_db->get('employment_detail', array($field, '=', $id));
				if($data->count()){
					$this->_data = $data->first();
					return $this->_data;
	...
	//Functions needed for Spouse function
	public function searchOnlySpouse($id = null){
		if($id){
			$field = (is_numeric($id)) ? 'userID' : 'spouse';
			$data = $this->_db->get('spouse', array($field, '=', $id));
			if($data->count()){
				$this->_data = $data->results();
				return $this->_data;
			}else{
	...
	public function getOnlySpouse($id = null){
		if($id){
			$field = (is_numeric($id)) ? 'userID' : 'id';
			$data = $this->_db->get('spouse', array($field, '=', $id));
